...
import time
import random
from instagram_private_api import Client, ClientError, ClientLoginRequiredError
...
def random_sleep(min_seconds, max_seconds, decimal_places):
    sleep_time = round(random.uniform(min_seconds, max_seconds), decimal_places)
    ...
    def __init__(self):
        ...
        try:
            ...
            verification_code = input(
                "Verification code of authenticator or SMS (phone number"
                f" ****{phone_number_tail}): "
            )
            try:
